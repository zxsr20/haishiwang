...
function pageAjax(){
	...
	var url = "";
	url="<%=basePath%>/sxMyStudyWay/sx_dataList.do?userid="+$("#userid").val();
...
<div class="user_detail">
	...
	<li>
		<a href="mycollect.do" class="icon_star">我的收藏 </a>
	</li>
...
<div class="course_detail">
					...
					<p class="course_info">
						<span title="四年级学生">
							本课程需在<strong>28</strong>天内学完　适用于：四年级学生						</span>
						<a href="javascript:void(0)" target="_blank">详情</a>
					</p>
					<p class="course_btnc">
						<a href="javascript:void(0)" class="btn_audition" target="_blank">
							免费试听
						</a>
						<a class="cancel_btn_fav" id="cancel_btn_fav" title="取消收藏" href="javascript:void(0);" onClick="delcolCou(9138,this)">取消收藏</a>
					</p>
				</div>
			</div>
			</div>
