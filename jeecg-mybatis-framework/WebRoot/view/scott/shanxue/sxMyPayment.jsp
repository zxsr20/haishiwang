...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">内容:</label><input name="content" class="easyui-box ui-text" style="width:100px;">
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
					...
					<div class="fitem">
						<label>收款人</label>
						<input name="to_userid" type="text" maxlength="" class="easyui-numberbox" data-options="" missingMessage="请填写收款人">
					</div>
					<div class="fitem">
						<label>金额</label>
						<input name="money" type="text" maxlength="" class="easyui-numberbox" data-options="" missingMessage="请填写金额">
					</div>
					<div class="fitem">
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxMyPayment.js"></script>
  </body>
</html>
