...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">类型code:</label><input name="type_code" class="easyui-box ui-text" style="width:100px;">
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
		     	   <div class="ftitle">课程类型表</div>
					<div class="fitem">
						<label>类型code</label>
						<input name="type_code" type="text" maxlength="20" class="easyui-validatebox" data-options="" missingMessage="请填写类型code">
					</div>
					<div class="fitem">
						<label>名称</label>
					...
					<div class="fitem">
						<label>CREATE_DATE2</label>
						<input name="create_date" type="text" maxlength="" class="easyui-datetimebox" data-options="" missingMessage="请填写CREATE_DATE2">
					</div>
					<div class="fitem">
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxCourseType.js"></script>
  </body>
</html>
