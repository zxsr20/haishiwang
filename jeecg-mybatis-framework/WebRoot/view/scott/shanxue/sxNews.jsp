  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			...
			<label class="ui-label">:</label><input name="content" class="easyui-box ui-text" style="width:100px;">
	    </p>
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxNews.js"></script>
  </body>
</html>
