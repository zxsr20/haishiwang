  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			...
			<label class="ui-label">CREATE_BY:</label><input name="create_by" class="easyui-box ui-text" style="width:100px;">
	    </p>
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxRecommendCourse.js"></script>
  </body>
</html>
