  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			...
			<label class="ui-label">课程id:</label><input name="courseid" class="easyui-box ui-text" style="width:100px;">
	    </p>
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
					...
					<div class="fitem">
						<label>什么时候看的</label>
						<input name="look_time" type="text" maxlength="" class="easyui-datetimebox" data-options="" missingMessage="请填写什么时候看的">
					</div>
					<div class="fitem">
						<label>播放到的时间</label>
						<input name="play_time" type="text" maxlength="" class="easyui-numberbox" data-options="" missingMessage="请填写播放到的时间">
					</div>
					<div class="fitem">
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxMyStudyWay.js"></script>
  </body>
</html>
