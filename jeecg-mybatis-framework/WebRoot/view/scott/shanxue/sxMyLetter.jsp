...
<html>
  ...
  <body class="easyui-layout">
 	 ...
 	 <form id="searchForm">
        <p class="ui-fields">
			<label class="ui-label">发件人:</label><input name="userid" class="easyui-box ui-text" style="width:100px;">
			<label class="ui-label">收件人:</label><input name="to_userid" class="easyui-box ui-text" style="width:100px;">
	    </p>
     ...
     <div id="edit-win" class="easyui-dialog" title="Basic window" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:400px;height:380px;">  
     	<form id="editForm" class="ui-form" method="post">  
     		 ...
     		 <div class="ui-edit">
		     	   <div class="ftitle">我的私信</div>
					<div class="fitem">
						<label>发件人</label>
						<input name="userid" type="text" maxlength="" class="easyui-numberbox" data-options="" missingMessage="请填写发件人">
					</div>
					<div class="fitem">
						<label>收件人</label>
						<input name="to_userid" type="text" maxlength="" class="easyui-numberbox" data-options="" missingMessage="请填写收件人">
					</div>
					<div class="fitem">
						<label>内容</label>
						<input name="content" type="text" maxlength="300" class="easyui-validatebox" data-options="" missingMessage="请填写内容">
					</div>
					<div class="fitem">
						<label>是否已读</label>
						<input name="readed" type="text" maxlength="1" class="easyui-validatebox" data-options="" missingMessage="请填写是否已读">
					</div>
					<div class="fitem">
  	 ...
  	 <script type="text/javascript" src="<%=basePath%>/view/scott/shanxue/page-sxMyLetter.js"></script>
  </body>
</html>
